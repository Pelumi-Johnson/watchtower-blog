...
This is a quick start template for [Hugo theme Stack](https://github.com/Pelumi/hugo-theme-stack). It uses [Hugo modules](https://gohugo.io/hugo-modules/) feature to load the theme.
...
```bash
hugo mod get -u github.com/pelumi/hugo-theme-stack/v3
hugo mod tidy
```
